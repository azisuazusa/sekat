            ...
            <div class="row mt-4 mb-4">
                <div class="col text-center">
                    <div class="input-group text-center">
                        <input type="text" id="question" class="form-control input-common" placeholder="Pertanyaan" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-4 mb-4">
                <div class="col text-center">
                    <div class="input-group">
                        ...
                        <input type="text" id="answer_a" class="form-control input-common" placeholder="Jawaban A" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-4 mb-4">
                <div class="col text-center">
                    <div class="input-group">
                        ...
                        <input type="text" id="answer_b" class="form-control input-common" placeholder="Jawaban B" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-4 mb-4">
                <div class="col text-center">
                    <div class="input-group">
                        ...
                        <input type="text" id="answer_c" class="form-control input-common" placeholder="Jawaban C" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-4 mb-4">
                <div class="col text-center">
                    <div class="input-group">
                        ...
                        <input type="text" id="answer_d" class="form-control input-common" placeholder="Jawaban D" readonly>
                    </div>
                </div>
            </div>
...
<script src="/dist/js/answerer_answer.js"></script>
</body>
</html>
